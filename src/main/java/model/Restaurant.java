...
public class Restaurant {
    ...
    public static int getDiscount() { return mealDiscount; }

    public static double getPrice(String foodName) { return priceMap.get(foodName); }

    public LinkedList<Order> getAllOrders() { return this.allOrders; }

    public int getRemainedFries() { return this.remainedFries; }
